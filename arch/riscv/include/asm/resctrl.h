 ...
 *
 * This series implements capacity allocation only and wires up no monitoring
 * events, so this always returns false. fs/resctrl references it
 ...
 *
 * This series implements no monitoring events, so there is no per-event
